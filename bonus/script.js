...
if (age < 18) {
    document.getElementById("sconto20").innerHTML += total20.toFixed(2)
} else if (age > 65) {
    document.getElementById("sconto20").innerHTML += total40.toFixed(2)
}
    else {
        document.getElementById("sconto20").innerHTML += cost.toFixed(2)
    }
